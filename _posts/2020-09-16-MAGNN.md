...
title: "MAGNN (Metapath: Metapath Aggregated Graph Neural Network for Heterogeneous Graph Embedding) Paper Review" categories: - Graph Neural Networks tags: - Graphs
